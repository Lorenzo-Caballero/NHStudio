...
const HeroBanner = () => {
  return (
    <div className="relative w-full h-screen flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="w-full md:w-1/2 h-full relative mt-20 md:mt-0 z-10">
        <video
      ...
      <div className="w-full md:w-1/2 h-full flex items-center justify-center p-8 bg-gradient-to-br from-[#4779a4] to-[#f7e7ce] text-white-900 mt-20 md:mt-0">
