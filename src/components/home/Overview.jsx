...
const Overview = () => {
    ...
    return (
        <motion.div
            ...
            className="w-full bg-[#F1D8F4] py-20 md:py-32 text-center text-[#9F5D23]"
        >
            <div className="px-3 lg:px-0 lg:w-[55%] mx-auto">
                ...
                <ScrollLink className="inline-block px-6 py-3 font-semibold tracking-wider text-white bg-purple-400 uppercase mt-8 text-lg hover:bg-purple-300" to="about" smooth={true} duration={500}>
                    Más sobre nosotros
                </ScrollLink>
            </div>
        </motion.div>
